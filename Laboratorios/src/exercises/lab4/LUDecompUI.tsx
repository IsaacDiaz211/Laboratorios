...
import { algo_LU_decomposition } from "./algos_SystemOfLinearEquations";
...
function LUDecompUI() {
  ...
  function handleSolve() {
    ...
    try {
      ...
      const x = algo_LU_decomposition(Aclone, bclone);
  ...
  return (
    <Flex vertical gap={16} style={{ maxWidth: 980, margin: "0 auto", padding: 16 }}>
      <Typography.Title level={3}>Factorización LU</Typography.Title>
